...
Dict_temp_5 = os.path.join(DATA_CLEAN_Temp, "dict_temp_5.p")
Dict_temp_6 = os.path.join(DATA_CLEAN_Temp, "dict_temp_6.p")
...
Nodes_loc_5 = os.path.join(DATA_CLEAN_Loc, "nodes_loc_5.p")
Nodes_loc_6 = os.path.join(DATA_CLEAN_Loc, "nodes_loc_6.p")
...
#Time
DATA_CLEAN_Larger_Density_Time = os.path.join(DATA_CLEAN_PATH, "Larger_density_time")
Larger_Density_Temp_time = os.path.join(DATA_CLEAN_Larger_Density_Time, "Temperature")


Larger_Density_Loc_time = os.path.join(DATA_CLEAN_Larger_Density_Time, "Location")
Larger_Density_loc_1_5 = os.path.join(Larger_Density_Loc, "nodes_loc_1_5.p")

Larger_Density_time_amp = os.path.join(DATA_CLEAN_Larger_Density_Time, "large_density_time_amp")