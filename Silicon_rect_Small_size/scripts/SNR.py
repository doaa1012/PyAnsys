...
# phase contrast will be calculted by  thermal phase angle images recorded, the phase angle
#contrast was evaluated by subtracting the phase angle located centrally over the defective regions from the phase angle measured in
#the healthy regions located near the circular cutouts
...
def SNR(loc, temp , fixed_y=0.04, fixed_x=0.07, rect_size=3, margin=1, label="Temperature"):
    ...
    SNR = 20 * np.log10(abs((mean_center- mean_nearby_noise ) / std_center))
